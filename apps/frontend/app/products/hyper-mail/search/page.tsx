...
//                 </div>
//                 <h2 className="text-lg font-semibold text-foreground sm:text-xl">How can I help you today?</h2>
//                 <p className="mt-1 text-sm text-muted-foreground">Ask me to summarize, draft, or search your emails</p>
//               </div>
//             )}
...
//         <div className="relative z-10 border-t border-border backdrop-blur-sm">
          ...
          <div className="mx-auto w-full max-w-3xl space-y-4">
            <div
              className={`flex flex-col items-center justify-center text-center transition-all duration-700 ease-in-out ${
                isChatStarted ? "max-h-0 opacity-0 overflow-hidden mb-0" : "max-h-[500px] opacity-100 mb-12 mt-10"
              }`}
            >
              ...
              {/* <h1 className="bg-linear-to-br from-foreground to-muted-foreground bg-clip-text text-3xl font-bold tracking-tight text-transparent sm:text-4xl md:text-5xl">
                AI Copilot for automating hyper-personalized messaging
              </h1> */}
                            <h1 className="bg-linear-to-br from-foreground to-muted-foreground bg-clip-text pb-1 text-3xl font-bold tracking-tight text-transparent sm:text-4xl md:text-5xl">
                AI Copilot for automating hyper-personalized messaging
              </h1>
