...
const EmailSearch = () => {
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 font-geist">
      ...
      <div className="flex flex-col md:flex-row shadow-sm rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 divide-y md:divide-y-0 md:divide-x divide-slate-200 dark:divide-slate-700 focus-within:border-slate-400 dark:focus-within:border-slate-600 font-geist">
        ...
        <Button className="h-14 w-full md:w-auto rounded-md px-8 font-semibold bg-white dark:bg-slate-900 text-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-base shadow-none border-0 focus-visible:ring-0 focus-visible:ring-offset-0" variant="ghost">
          Find
        </Button>
      </div>
